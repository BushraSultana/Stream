...
public class MapTasks {
    public static void main(String[] args) {
        ...
        customers.put("C1", new Customer("C1", "Bushra", "India", 25, 3, 4500, 3, 12));
        customers.put("C2", new Customer("C2", "Nehal", "India", 33, 7, 5200, 5, 40));
        customers.put("C3", new Customer("C3", "Amritha", "USA", 29, 5, 1800, 2, 20));
        customers.put("C4", new Customer("C4", "Sneha", "UK", 40, 10, 7000, 7, 30));
        customers.put("C5", new Customer("C5", "Kirthana", "India", 23, 2, 3000, 3, 10));
        ...
        customers.put("C9", new Customer("C9", "Sumanantha", "India", 22, 1, 2700, 2, 8));
        ...
        // Filter customers: joined last 3 years + loyalty<4 + balance 2000-5000
